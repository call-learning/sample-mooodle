...
$string['server_help'] = 'This sets the hostname or IP address of the Redis server to use (IP:PORT). Note that if enabled, it will be the Redis Sentinel IP address.';
$string['issentinel'] = 'Is Sentinel';
$string['issentinel_help'] = 'If checked the server will be considered as Redis Sentinel and use a different protocol.';
$string['mastername'] = 'Redis Master Name';
$string['mastername_help'] = 'The master name we will use in the SENTINEL get-master-addr-by-name query.';
...
$string['test_is_sentinel'] = 'Is Test server a Redis Sentinel';
$string['test_is_sentinel_desc'] = 'This will allow testing Redis behind sentinel.';
$string['test_sentinel_master'] = 'Test Sentinel Master name';
$string['test_sentinel_master_desc'] = 'Redis test server master name.';
